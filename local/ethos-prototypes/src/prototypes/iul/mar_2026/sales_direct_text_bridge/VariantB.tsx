/**
 * Variant B — Expectation + Low Commitment Copy (Jeff's Concept 1)
 * "Check your phone." Text positions as a low-commitment entry point.
 * Hypothesis: naming the text + framing as low-pressure reduces call aversion.
 */
...
export default function VariantB() {
  return (
    <div className="min-h-screen" style={{ background: '#e5e5e7', padding: '24px 16px' }}>
      <VariantNav current="/iul/sales-direct-text-bridge/v2" />
      <PhoneFrame>
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '660px', background: 'white' }}>
          ...
          <div style={{ flex: 1, padding: '32px 24px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <h1 style={{ ...type.h1, textAlign: 'center', marginBottom: '16px' }}>
              You're pre-approved—check your texts!
            </h1>
            <p style={{ ...type.cardDescription, textAlign: 'center', color: '#5d5d5d', lineHeight: '26px' }}>
              One of our IUL experts sent you a text to walkthrough your coverage. Coordinate with them soon to get your IUL growth started.
            </p>
          </div>
