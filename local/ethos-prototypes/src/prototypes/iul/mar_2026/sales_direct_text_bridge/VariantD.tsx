/**
 * Variant D — Value Anchoring / Reveal Copy (Jeff's Concept 2)
 * "Your policy details are ready." Text delivers results users came for.
 * Hypothesis: value anchoring reframes text from agent outreach to results delivery.
 */
...
export default function VariantD() {
  return (
    <div className="min-h-screen" style={{ background: '#e5e5e7', padding: '24px 16px' }}>
      <VariantNav current="/iul/sales-direct-text-bridge/v4" />
      <PhoneFrame>
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '660px', background: 'white' }}>
          ...
          <div style={{ flex: 1, padding: '32px 24px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <h1 style={{ ...type.h1, textAlign: 'center', marginBottom: '16px' }}>
              Your rate is ready! Our agent is ready to walk you through it.
            </h1>
            <p style={{ ...type.cardDescription, textAlign: 'center', color: '#5d5d5d', lineHeight: '26px' }}>
              We just texted you to schedule a call. When you're ready, an agent will let you know your rate and walk you through everything.
            </p>
          </div>
          <div style={{ padding: '24px 24px 40px' }}>
            <p style={{ fontFamily: NH, fontSize: '14px', color: '#7e7e7e', textAlign: 'center', marginBottom: '10px' }}>
