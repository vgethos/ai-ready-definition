...
**Proposed copy (Jeff's Concept 1 — Expectation + Low Commitment):**

- Headline: "You're pre-approved for IUL—check your phone!"
- Body: "One of our IUL experts sent you a text to find a good time to get you approved. They can answer any questions you have over text as well."
- CTA: "Skip the line—call now"
...
- Headline: "Your rate is ready — you decide when to go over it."
- Body: "We sent you a text. Use it to pick a time that works for you, and one of our IUL experts will call then."
- CTA: "Skip the line—call now"
...
**Proposed copy (Jeff's Concept 2 — Excitement + Reveal):**

- Headline: "Great news—you've been pre-approved for IUL!"
- Body: "Your policy details are ready: cash value growth, lifelong coverage, and your rate. One of our IUL experts sent you a text to walk you through it all."
- CTA: "Skip the line—call now"
